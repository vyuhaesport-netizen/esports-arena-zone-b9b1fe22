  	...
  	extend: {
		...
		colors: {
  		...
  		backgroundImage: {
  			...
  			'gradient-primary': 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--gaming-purple)))',
  			'gradient-success': 'linear-gradient(135deg, hsl(var(--success)), hsl(var(--gaming-cyan)))'
  		}
  	}
  },
