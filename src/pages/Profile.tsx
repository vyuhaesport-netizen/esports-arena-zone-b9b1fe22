...
const ProfilePage = () => {
  ...
  const SocialLinks = () => {
    ...
    if (!socialLinks.discord && !socialLinks.instagram && !socialLinks.youtube) {
      return null;
    }

    return (
      <div className="px-4 pt-4">
        <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Follow Us</h3>
        <div className="flex gap-3 justify-center">
          {socialLinks.discord && (
            <a
              ...
              className="w-12 h-12 rounded-xl bg-indigo-500/10 flex items-center justify-center hover:bg-indigo-500/20 transition-colors"
            >
          ...
          {socialLinks.instagram && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-xl bg-pink-500/10 flex items-center justify-center hover:bg-pink-500/20 transition-colors"
            >
          ...
          {socialLinks.youtube && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-xl bg-red-500/10 flex items-center justify-center hover:bg-red-500/20 transition-colors"
            >
